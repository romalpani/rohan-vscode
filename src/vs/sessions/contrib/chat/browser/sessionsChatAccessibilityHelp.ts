...
export class SessionsChatAccessibilityHelp implements IAccessibleViewImplementation {
	...
	getProvider(accessor: ServicesAccessor) {
		...
		content.push(localize('sessionsChat.renameSession', "To rename the active session, open the session title's actions menu and choose Rename. You can also double-click its title in the sessions list, or focus the list item, open its context menu (for example, with Shift+F10), and choose Rename."));
